...
class AcalaEntryNew extends StatefulWidget {
  AcalaEntryNew(this.plugin, this.keyring);

  final PluginKarura plugin;
  final Keyring keyring;

  @override
  _AcalaEntryNewState createState() => _AcalaEntryNewState();
}

class _AcalaEntryNewState extends State<AcalaEntryNew> {
