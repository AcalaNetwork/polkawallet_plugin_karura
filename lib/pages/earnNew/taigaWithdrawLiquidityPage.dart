...
class _TaigaWithdrawLiquidityPageState
  ...
  String? _validateInput(String? value) {
    ...
    final balancePair = taigaToken.tokens!
    ...
    return PluginScaffold(
        ...
        body: Observer(builder: (_) {
          ...
          final balance = AssetsUtils.getBalanceFromTokenNameId(
              widget.plugin, taigaToken.tokenNameId);
          var totalBalance =
              Fmt.tokenInt(taigaPool!.userShares, balance.decimals!) +
                  Fmt.tokenInt(balance.amount, balance.decimals!);
                                ...
                                children: [
                                  PluginInfoItem(
                                    ...
                                    content: Fmt.priceFloorBigInt(
                                        BigInt.parse(taigaPool.userShares) +
                      ...
                      Padding(
                          ...
                          child: Column(
                            children: [
                              Stack(
                                children: [
                                  PluginTextTag(
                                    ...
                                    backgroundColor: Color(0xFF974DE4),
                                    style: Theme.of(context)
                                        .textTheme
                                        .headline4
                                        ?.copyWith(
                              ...
                              Padding(
                                  padding:
                                      EdgeInsets.only(top: 141, bottom: 38),
                                  child: PluginButton(
